    ...
    begin {
        ...
        function Get-EdgeHistory {
            ...
            process {
                ...
                Resolve-Path -Path "$env:SystemDrive\Users\*\AppData\Local\Microsoft\Edge\User Data\Default\History" |
		...
		$EdgeFunction = "function Get-EdgeHistory { ${function:Get-EdgeHistory} }"
            ...
            if ($AsJob) {
                ...
                if ($EachComputer -match $env:COMPUTERNAME) {
                    ...
                    Start-Job -ScriptBlock {
						...
						Get-EdgeHistory -UserName $UserName -SearchTerm $SearchTerm
                    ...
                    } -ArgumentList $UserName,$SearchTerm,$ChromeFunction,$IeFunction,$FireFoxFunction,$EdgeFunction -AsJob
                ...
                if ($EachComputer -match $env:COMPUTERNAME) {
                    ...
                    Invoke-Command -ComputerName $EachComputer -ScriptBlock {
						...
						. ([ScriptBlock]::Create($EdgeFunction))
                    ...
                    } -ArgumentList $UserName,$SearchTerm,$ChromeFunction,$IeFunction,$FireFoxFunction,$EdgeFunction |
